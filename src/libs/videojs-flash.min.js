...
!(function(e, t) {
            ...
            d = (function(e) {
                function t(r, n) {
                    ...
                    return (
                        ...
                        (o.videojs.Flash.onReady = t.onReady),
                        (o.videojs.Flash.onEvent = t.onEvent),
                        (o.videojs.Flash.onError = t.onError),
                        s.on('seeked', function() {
                ...
                return (
                    ...
                    (t.prototype.createEl = function() {
                        ...
                        return (
                            (this.el_ = t.embed(e.swf, n, o, i)), (this.el_.tech = this), this.el_
                        );
                    }),
                    ...
                    (t.prototype.setCurrentTime = function(t) {
                        ...
                        r.length &&
                            ((t =
                                (t = t > r.start(0) ? t : r.start(0)) < r.end(r.length - 1)
                                    ? t
                                    : r.end(r.length - 1)),
                    ...
                    (t.prototype.buffered = function() {
                        ...
                        return 0 === e.length ? l() : l(e[0][0], e[0][1]);
                    }),
    ...
    return (
        ...
        s.withSourceHandlers(d),
        (d.nativeSourceHandler = {}),
        (d.nativeSourceHandler.canPlayType = function(e) {
            return e in d.formats ? 'maybe' : '';
        }),
        (d.nativeSourceHandler.canHandleSource = function(e, t) {
            var r = void 0;
            return (
                (r = e.type
                    ? e.type.replace(/;.*/, '').toLowerCase()
                    : (function(e) {
                          var t = u.getFileExtension(e);
                          return t ? 'video/' + t : '';
                      })(e.src)),
                d.nativeSourceHandler.canPlayType(r)
            );
        }),
        (d.nativeSourceHandler.handleSource = function(e, t, r) {
            t.setSrc(e.src);
        }),
        ...
        (d.onError = function(e, t) {
            ...
            'string' == typeof t ? r.error('FLASH: ' + t) : ((t.origin = 'flash'), r.error(t));
        }),
        (d.version = function() {
            var e = '0,0,0';
            try {
                ...
                try {
                    f.mimeTypes['application/x-shockwave-flash'].enabledPlugin &&
                        (e = (
                            f.plugins['Shockwave Flash 2.0'] || f.plugins['Shockwave Flash']
                        ).description
                            .replace(/\D+/g, ',')
                            .match(/^,?(.+),?$/)[1]);
                } catch (r) {}
        ...
        (d.embed = function(e, t, r, n) {
            var o = d.getEmbedCode(e, t, r, n);
            return c.createEl('div', { innerHTML: o }).childNodes[0];
        }),
        (d.getEmbedCode = function(e, t, r, n) {
            var o = '',
                i = '',
                a = '';
            return (
                ...
                (r = p(
                    { movie: e, flashvars: o, allowScriptAccess: 'always', allowNetworking: 'all' },
                    r
                )),
                Object.getOwnPropertyNames(r).forEach(function(e) {
                    i += '<param name="' + e + '" value="' + r[e] + '" />';
                }),
                (n = p({ data: e, width: '100%', height: '100%' }, n)),
        ...
        (function(e) {
            (e.streamingFormats = { 'rtmp/mp4': 'MP4', 'rtmp/flv': 'FLV' }),
