        ...
        return (
            <Modal
                ...
                footer={[
                    <Button
                        key="cancel"
                        onClick={() => closeModal('bindVisible')}
                    >
                        {formatMessage({ id: 'btn.cancel' })}
                    </Button>,
                    <Button
            ...
            >
                <Row>
                    ...
                    <Row>
                        <Col span={4}>{formatMessage({ id: 'esl.device.esl.select.product' })}:</Col>
                        <Col span={20}>
                            <Input.Search
                                placeholder={formatMessage({ id: 'esl.device.esl.bind.input.placeholder' })}
