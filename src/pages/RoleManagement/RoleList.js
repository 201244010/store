...
import { Input, Button, Table, Popconfirm, Icon, Divider, Form, Row, Col, message } from 'antd';
...
class RoleList extends React.Component {
	...
	deleteRole = async rowDetail => {
		...
		if (response && response.code === ERROR_OK) {
			...
			message.error(formatMessage({ id: ALERT_NOTICE_MAP[response.code] }) || formatMessage({ id: 'roleManagement.role.deleteFail' }));
		};
	};
