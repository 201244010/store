		...
		[
			{
				...
				value: [promoteStartDate ? moment(promoteStartDate) : '', promoteEndDate ? moment(promoteEndDate) : ''],
				required: false,
				message: '',
				validator: false,
				field: '',
			},
			{
				...
				value: [memberPromoteStartDate ? moment(memberPromoteStartDate) : '', memberPromoteEndDate ? moment(memberPromoteEndDate) : ''],
				required: false,
				message: '',
				validator: false,
				field: '',
