    ...
    return (
      <div>
        <div className={styles['table-header']}>
          ...
          <Button className={styles['function-btn']}>{formatMessage({ id: 'btn.delete' })}</Button>
        </div>
            ...
            pagination={{
              ...
              showTotal: total =>
                selectedRowKeys.length === 0
                  ? `${formatMessage({ id: 'pagination.total.prefix' })}${total}${formatMessage({
                  ...
                  : `${formatMessage({ id: 'pagination.total.prefix' })}${total}${formatMessage({
                    ...
                    }${formatMessage({ id: 'basicData.product.pagination.unit' })}`,
            }}
