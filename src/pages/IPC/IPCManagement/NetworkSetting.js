        ...
        return (
            <div>
                <Card
                    ...
                    title={<FormattedMessage id="networkSetting.title" />}
                >
                    <Form>
                ...
                <Modal
                    ...
                    footer={[
                        <Button onClick={this.handleCancel}>
                            <FormattedMessage id="networkSetting.cancel" />
                        </Button>,
                        <Button type="primary" onClick={this.handleConnect}>
                            <FormattedMessage id="networkSetting.connect" />
                        </Button>,
                    ]}
                >
                    {isSearch ? (
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            <Form.Item label={<FormattedMessage id="networkSetting,ssidList" />}>
                                <Select
                                    ...
                                    placeholder={
                                        <FormattedMessage id="networkSetting.chooseNetwork" />
                                    }
                                >
                                    {wifiList
                                        ? wifiList.map(item => (
                            ...
                            {isSelect ? (
                                <Form.Item
                                    label={<FormattedMessage id="networkSetting.password" />}
                                >
                            ...
                            {isConnecting && !isConnected ? (
                                <FormattedMessage id="networkSetting.connectMsg" />
                            ) : (
                                ''
                            )}
                        </Form>
                    ...
                    {status === 'success' ? (
                        <Alert
                            type="success"
                            message={<FormattedMessage id="networkSetting.successMsg" />}
                        />
                    ) : (
                        ''
                    )}
                    {status === 'error' ? (
                        <Alert
                            type="error"
                            message={<FormattedMessage id="networkSetting.failMsg" />}
                        />
                    ) : (
                        ''
                    )}
