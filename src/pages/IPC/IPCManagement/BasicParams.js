                    ...
                    <Form.Item label={<FormattedMessage id="basicParams.nightMode" />}>
                        {getFieldDecorator('nightMode', {
                            ...
                            <RadioGroup inChange={this.onAutoChange}>
                                <Radio value={1}>
                                    <FormattedMessage id="basicParams.autoSwitch" />
                                </Radio>
                                <Radio value={2}>
                                    <FormattedMessage id="basicParams.open" />
                                </Radio>
                                <Radio value={3}>
                                    <FormattedMessage id="basicParams.close" />
                                </Radio>
                            </RadioGroup>
                        )}
                    </Form.Item>
                    <Form.Item label={<FormattedMessage id="basicParams.statusIndicator" />}>
                        {getFieldDecorator('indicator', {
                            ...
                            <Switch
                                ...
                                unCheckedChildren={
                                    <FormattedMessage id="basicParams.label.close" />
                                }
                            />
                        )}
                    </Form.Item>
