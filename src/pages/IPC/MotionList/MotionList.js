        ...
        },
        {
            ...
            render: item => (
                <span
                    ...
                    onClick={() => this.watchVideoHandler(item)}
                >
    ...
    render() {
        ...
        return (
            <Card>
                <div
                    className={
                        !isWatchVideo ? styles['motion-list-container'] : styles['display-none']
                    }
                >
                    <Row gutter={24} style={{ marginLeft: '10px' }}>
                        <Col lg={20} xl={8} xxl={6} style={{ marginTop: '10px' }}>
                            ...
                            <Select
                                defaultValue="0"
                                placeholder={<FormattedMessage id="motionList.select.ipcName" />}
                                style={{ width: '68%' }}
                            ...
                            >
                                ...
                                {ipcList &&
                                    ipcList.map((item, index) => (
                                        <Option key={`ipc-selector${index}`} value={item.deviceId}>
                                            {item.deviceName}
                                        </Option>
                                    ))}
                            </Select>
                        ...
                        <Col lg={20} xl={7} xxl={6} style={{ marginTop: '10px' }}>
                            ...
                            <Select
                                defaultValue="0"
                                placeholder={
                                    <FormattedMessage id="motionList.select.detectedSource" />
                                }
                                style={{ width: '70%' }}
                        ...
                        <Col lg={16} xl={3} xxl={2} style={{ marginTop: '10px' }}>
                            ...
                            >
                                <FormattedMessage id="motionList.search" />
                            </Button>
                        </Col>
                    </Row>
                    <br />
