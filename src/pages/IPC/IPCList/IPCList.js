                                    ...
                                    return (
                                        <div key={index}>
                                            ...
                                            >
                                                ...
                                                <div className={styles['ipc-name-type']}>
                                                    {item.name || (
                                                        <FormattedMessage id="ipcList.noIPCName" />
                                                    )}{' '}
                                                    (
                                                    {item.type || (
                                                        <FormattedMessage id="ipcList.noIPCType" />
                                                    )}
                                                    )
                                                </div>
                                            </Col>
                                        ...
                                        <div key={index}>
                                            ...
                                            >
                                                ...
                                                <div className={styles['outline-tips']}>
                                                    <h3>
                                                        {
                                                            <FormattedMessage id="ipcList.devices.outline.tips" />
                                                        }
                                                    </h3>
                                                </div>
                                                <div className={styles['ipc-name-type']}>
                    ...
                    <div className={styles['no-device']}>
                        ...
                        <div className={styles.tips}>
                            <div className={styles['tips-item']}>
                                ...
                                {<FormattedMessage id="ipcList.noDevice.addIPC.first.step" />}
                                <span className={styles['blue-span']}>
                                    {
                                        <FormattedMessage id="ipcList.noDevice.addIPC.first.step.blue" />
                                    }
                                </span>
                            </div>
                            <div className={styles['tips-item']}>
                                <span className={styles.num}>2</span>
                                {<FormattedMessage id="ipcList.noDevice.addIPC.second.step" />}
                            </div>
                        </div>
                        <div className={styles['ipc-pic']} />
                        <Button className={styles['device-link']} type="primary">
