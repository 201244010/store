export default {
	...
	'cardManagement.videoTimeLength': '视频存储时长',
	'cardManagement.videoTimeLengthTip': '视频存储时长为存储卡内存储的总视频时长，当存储卡容量到达上限后，会以循环存储的方式存视频，即新的直播回放视频会自动覆盖最早的视频',
	'cardManagement.videoStartTime': '起始时间',
	'cardManagement.videoEndTime': '截止时间',
	'cardManagement.hasUsed': '已使用',
	'cardManagement.day': '天',
	'cardManagement.hour': '小时',
	'cardManagement.minute': '分钟',
	'cardManagement.dateYear': '年',
	'cardManagement.dateMonth': '月',
	'cardManagement.dateDay': '日',
	'cardManagement.dateHour': '时',
	'cardManagement.dateMinute': '分',
	'cardManagement.dateSecond': '秒',
