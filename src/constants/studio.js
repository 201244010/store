...
export const FORMATS = {
    ...
    DEFAULT_PRICE_FONT_SIZE: 16,
};

const fillMap = {
    [SHAPE_TYPES.RECT]: COLORS.DEFAULT_RECT_BG_COLOR,
    [SHAPE_TYPES.TEXT]: COLORS.DEFAULT_TEXT_COLOR,
    [SHAPE_TYPES.PRICE_NORMAL]: COLORS.DEFAULT_TEXT_COLOR,
    [SHAPE_TYPES.PRICE_SUPER]: COLORS.DEFAULT_TEXT_COLOR,
    [SHAPE_TYPES.PRICE_SUB]: COLORS.DEFAULT_TEXT_COLOR,
};
const widthMap = {
    ...
    [SHAPE_TYPES.PRICE_SUPER]: SIZES.DEFAULT_PRICE_CONTAINER_WIDTH,
    [SHAPE_TYPES.PRICE_SUB]: SIZES.DEFAULT_PRICE_CONTAINER_WIDTH,
};
const heightMap = {
    ...
    [SHAPE_TYPES.PRICE_SUPER]: SIZES.DEFAULT_PRICE_CONTAINER_HEIGHT,
    [SHAPE_TYPES.PRICE_SUB]: SIZES.DEFAULT_PRICE_CONTAINER_HEIGHT,
};
...
const alignMap = {
    ...
    [SHAPE_TYPES.PRICE_SUPER]: FORMATS.DEFAULT_TEXT_ALIGN,
    [SHAPE_TYPES.PRICE_SUB]: FORMATS.DEFAULT_TEXT_ALIGN,
};
const fontFamilyMap = {
    [SHAPE_TYPES.TEXT]: FORMATS.DEFAULT_TEXT_FONT_FAMILY,
    [SHAPE_TYPES.PRICE_NORMAL]: FORMATS.DEFAULT_TEXT_FONT_FAMILY,
    [SHAPE_TYPES.PRICE_SUPER]: FORMATS.DEFAULT_TEXT_FONT_FAMILY,
    [SHAPE_TYPES.PRICE_SUB]: FORMATS.DEFAULT_TEXT_FONT_FAMILY,
};
const fontSizeMap = {
    [SHAPE_TYPES.TEXT]: FORMATS.DEFAULT_TEXT_FONT_SIZE,
    [SHAPE_TYPES.PRICE_NORMAL]: FORMATS.DEFAULT_PRICE_FONT_SIZE,
    [SHAPE_TYPES.PRICE_SUPER]: FORMATS.DEFAULT_PRICE_FONT_SIZE,
    [SHAPE_TYPES.PRICE_SUB]: FORMATS.DEFAULT_PRICE_FONT_SIZE,
};
const fontStyleMap = {
    [SHAPE_TYPES.TEXT]: FORMATS.DEFAULT_TEXT_FONT_STYLE,
    [SHAPE_TYPES.PRICE_NORMAL]: FORMATS.DEFAULT_TEXT_FONT_STYLE,
    [SHAPE_TYPES.PRICE_SUPER]: FORMATS.DEFAULT_TEXT_FONT_STYLE,
    [SHAPE_TYPES.PRICE_SUB]: FORMATS.DEFAULT_TEXT_FONT_STYLE,
};
const textBgMap = {
    [SHAPE_TYPES.TEXT]: COLORS.DEFAULT_TEXT_BG_COLOR,
    [SHAPE_TYPES.PRICE_NORMAL]: COLORS.DEFAULT_TEXT_BG_COLOR,
    [SHAPE_TYPES.PRICE_SUPER]: COLORS.DEFAULT_TEXT_BG_COLOR,
    [SHAPE_TYPES.PRICE_SUB]: COLORS.DEFAULT_TEXT_BG_COLOR,
};
const textDecorationMap = {
    ...
    [SHAPE_TYPES.PRICE_SUPER]: FORMATS.DEFAULT_TEXT_DECORATION,
    [SHAPE_TYPES.PRICE_SUB]: FORMATS.DEFAULT_TEXT_DECORATION,
};
const screenMap = {
    1: {
        width: 212,
