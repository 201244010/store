...
export const productInfo = /^([0-9]{1,6})(\.[0-9]{1,6}){0,1}$/;
export const cellphone = /^[1][0-9]{10}$/;
export const telephone = /^([0-9]{3,4}-)?([2-9][0-9]{2,7}-?)+([-#][0-9]{1,4}){0,}$/;
export const phone = /^([1][0-9]{10})$|((0\d{2}-\d{8}(-\d{1,4})?)$|(0\d{3}-\d{7,8}(-\d{1,4})?))$/;

export const money = /(^[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/;

export const area = /^(([1-9]\d{0,5})|0)(\.\d{1,2})?$/;
