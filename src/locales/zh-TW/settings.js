export default {
	...
	'app.settings.basic.phone': '聯繫電話',
	'app.settings.basic.phone-message': '請輸入您的聯繫電話!',
	...
	'app.settings.security.question-description': '未設置密保問題，密保問題可有效保護帳戶安全',
	'app.settings.security.email': '備用郵箱',
	'app.settings.security.email-description': '已綁定郵箱：',
	'app.settings.security.mfa': 'MFA設備',
	'app.settings.security.mfa-description': '未綁定MFA設備，綁定後，可以進行二次確認',
	...
	'app.settings.binding.alipay-description': '當前未綁定支付寶帳號',
	'app.settings.binding.dingding': '綁定釘釘',
	'app.settings.binding.dingding-description': '當前未綁定釘釘帳號',
