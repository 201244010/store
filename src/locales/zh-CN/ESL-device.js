export default {
	...
	'esl.device.display.page.toggle.tooltip':
		'价签支持本地存储多张图片，可快速切换。如果开启了页面切换功能，会因为同时下发多张图片而减慢整体刷图速度。',
	'esl.device.display.not.bind.title': '未绑定价签显示模板',
	'esl.device.display.page.name': '页面名称',
	'esl.device.display.sl121.tooltip':
		'选择了模板则开启页面切换功能，价签切换到对应页面后将以设置的模板进行显示；选择不显示则价签只能切换至第一页的价格显示页。',
	...
	'esl.device.config.scan.refresh.desc':
		'为保证价签电子墨水屏显示效果，价签需要定期进行自刷新，推荐每天刷新。',
	...
	'esl.device.config.boardcast.startTime.desc':
		'开启注册广播后，所有基站将只发送注册广播，方便价签注册。注册广播开启时长到期后，将自动关闭',
