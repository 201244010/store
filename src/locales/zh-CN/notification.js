export default {
	...
	'notif-import-product-finish-desc': '商品导入完成，商品总数##total_num##, 成功导入总数##current_num##',
	...
	'notif-import-product-finish-content': '商品导入完成，商品总数##total_num##, 成功导入总数##current_num##',
	...
	'notif-device-ipc-motion-detect-video-desc': '【##company_name##-##shop_name##】网络摄像机(##device_name##)侦测到异常画面，请即刻查看',
	'notif-device-ipc-motion-detect-audio-desc': '【##company_name##-##shop_name##】网络摄像机(##device_name##)侦测到异常声音，请即刻查看',
	'notif-device-ipc-motion-detect-video-audio-desc': '【##company_name##-##shop_name##】网络摄像机(##device_name##)侦测到异常画面与声音，请即刻查看',
	...
	'notif-device-ipc-tf-card-detect-tf-non-exist-desc': '【##company_name##-##shop_name##】网络摄像机(##device_name##)的存储卡未插入或被拔出，请检查',
	'notif-device-ipc-tf-card-detect-tf-exist-desc': '【##company_name##-##shop_name##】网络摄像机(##device_name##)检测到有新存储卡插入，请查看',
	'notif-device-ipc-tf-card-detect-tf-capable-desc': '【##company_name##-##shop_name##】网络摄像机(##device_name##)检测到可用的存储卡，请查看',
	'notif-device-ipc-tf-card-detect-tf-non-capable-desc': '【##company_name##-##shop_name##】网络摄像机(##device_name##)检测到存储卡异常，请查看',
	...
	'notif-device-ipc-ota-content': '网络摄像机(##device_name##)已发布新版固件##bin_version##，请更新',
	'notif-device-ipc-motion-detect-video-content': '网络摄像机(##device_name##)侦测到异常画面，请即刻查看',
	'notif-device-ipc-motion-detect-audio-content': '网络摄像机(##device_name##)侦测到异常声音，请即刻查看',
	'notif-device-ipc-motion-detect-video-audio-content': '网络摄像机(##device_name##)侦测到异常画面与声音，请即刻查看',
	'notif-device-ipc-on/offline-content': '网络摄像机(##device_name##)于##disconnect_time##离线，请检查设备状态',
	...
	'notif-device-ipc-tf-card-detect-tf-exist-content': '网络摄像机(##device_name##)检测到有新存储卡插入，建议格式化，用于本地存储监控视频',
	'notif-device-ipc-tf-card-detect-tf-non-exist-content': '网络摄像机(##device_name##)的存储卡未插入或被拔出，请检查',
	'notif-device-ipc-tf-card-detect-tf-capable-content': '网络摄像机(##device_name##)检测到可用的存储卡，可用于本地存储监控视频',
	'notif-device-ipc-tf-card-detect-tf-non-capable-content': '网络摄像机(##device_name##)检测到插入的存储卡可能已损坏，请更换存储卡',
	...
	'notif-system-task-erp-finish-desc': '【##company_name##-##shop_name##】已完成与 (##saas_name##) 的对接，成功获取 ##total_count## 条商品信息',
	'notif-system-task-erp-failure-desc': '【##company_name##-##shop_name##】未能完成与<(##saas_name##)>的对接，请重试',
	'notif-device-esl-ota-desc': '【##company_name##-##shop_name##】##device_name##已发布新版固件##bin_version##，请更新',
	...
	'notif-device-esl-image-push-status-content': '商品##product_name##价签##esl_code##于##push_time##推送失败',
